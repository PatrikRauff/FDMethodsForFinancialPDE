...
public:
	...
	static bool	fdRunner(
		...
		const double		theta,		//  Weight of scheme.
		const int			wind,
		const double		numStd,
		const int			numt,
		const int			numx,
	...
	// The fwd finite difference scheme - Greens function
	//Outputs Transition probabilities with the fwd Roll Algo
